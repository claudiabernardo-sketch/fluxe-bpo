...
const CATS = [
  {
    ...
    titulo:'Primeiros Passos', artigos:[
      ...
      { titulo:'Criar o primeiro cliente', tempo:'4 min', conteudo:'São 3 passos, nessa ordem, pra esse cliente começar a gerar tarefa sozinho:\n\n1) Acesse o módulo Clientes e clique em "Novo cliente". Preencha nome, CNPJ e contato, e salve.\n\n2) Abra o cliente e vá na aba "🔁 Rotina". Cadastre uma rotina pra cada serviço que você presta pra ele (ex: "Conciliação bancária", "Folha de pagamento"), com a frequência (diária, semanal, mensal ou anual) e o horário. Sem isso, o próximo passo não mostra nada pra vincular.\n\n3) Vá em Modelos, selecione esse cliente no filtro do topo. O Fluxe cruza as rotinas que você acabou de cadastrar com os modelos disponíveis (comparando o título) e mostra um botão "Vincular" pra cada uma que encontrar par. Clique em Vincular em cada uma, isso ativa a geração automática das tarefas.\n\nSe o título da rotina não bater com nenhum modelo, não aparece o botão Vincular pra ela. Veja o artigo "Vincular modelos ao cliente" pra entender esse cruzamento em detalhe, e "Biblioteca de modelos prontos" se ainda não importou os 50 modelos já prontos (mais fácil dar nome de rotina que bate com um modelo que já existe do que criar modelo do zero).' },
