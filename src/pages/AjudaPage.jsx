...
const CATS = [
  ...
  },
  {
    ...
    titulo:'Cofre Digital', artigos:[
      { titulo:'Guardar senhas e acessos de clientes', tempo:'2 min', conteudo:'No Cofre, cadastre sistema, login e senha de cada acesso do cliente (banco, ERP, portal da prefeitura, etc.), com criptografia. Assim, quando um analista sai da equipe, ninguém perde acesso a nada.\n\nPra guardar um acesso que não é de nenhum cliente, e sim da sua própria empresa (o sistema contábil do seu BPO, o e-mail da empresa, o banco da empresa), clique em "+ Novo acesso" e deixe o campo Cliente na opção "🔐 Acesso interno (minha empresa)". Esses acessos aparecem separados dos dos clientes, num grupo próprio.' },
    ]
  },
  {
  ...
  },
  {
    ...
    titulo:'Mentoria', artigos:[
      ...
      { titulo:'Calendário e progresso das aulas da turma', tempo:'2 min', conteudo:'Se você faz parte de uma turma da Mentoria em Grupo, a seção "Aulas da Turma" mostra um calendário do mês com cada aula marcada no dia certo (fica verde quando você já concluiu). Clique num dia com aula pra abrir ela, com material, vídeo e exercício. Use os botões "‹" e "›" pra navegar entre os meses, e o botão "📋 Lista" se preferir ver tudo em lista em vez de calendário.\n\nPra marcar uma aula como concluída, clique no círculo numerado dela — ele fica verde com um ✓ — isso alimenta seu progresso, que sua mentora acompanha do lado dela.' },
