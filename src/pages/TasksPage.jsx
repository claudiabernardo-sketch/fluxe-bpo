        ...
        <div onClick={e => e.stopPropagation()} style={{ padding:'0 12px 8px 44px', display:'flex', alignItems:'center', gap:6 }}>
          {editandoMotivo ? (
            <>
              ...
              <button onClick={e => { e.stopPropagation(); setEditandoMotivo(false) }} style={{ fontSize:10, padding:'3px 8px', borderRadius:6, border:'1px solid #E2E8F0', background:'#fff', color:'#94A3B8', cursor:'poi